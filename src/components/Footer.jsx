    ...
    return (
        <>
            ...
            <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#5524B7] to-[#380B60] text-white/70">
                ...
                <p className="mt-4 text-center">Copyright © 2025 <Link to='/'>Luins</Link>. All rights reservered.</p>
...
>
  ...
  >
    ...
    />
                    ...
                    <Link to="/instagram" className="hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <Link to="/linkedin" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link to="/twitter" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link to="/github" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
